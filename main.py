...
BOT_TOKEN = "8316471262:AAG2hWekWbCFJ2nyWOCtn0CJzX_VSi28gb8"
...
def safe_send_admin(update: Update, context: ContextTypes.DEFAULT_TYPE, error_text: str):
    """Отправляет уведомление админу, но не чаще раза в минуту."""
    now = time.time()
    ...
    if now - last > 60:
        ...
        try:
            ...
            pass  # если не удалось отправить – ничего не делаем
...
async def handle_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Отправляем уведомление админу (без логов)
...
def main():
    ...
    print("Бот запущен и готов к работе (логи отключены, ошибки только админу)")
